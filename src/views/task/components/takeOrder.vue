<template>
  ...
  <div>
    <el-form inline>
      <el-form-item>
        <el-select placeholder="任务名称" v-model="query.keyword"></el-select>
      </el-form-item>
      <el-form-item>
        <el-select placeholder="接单人姓名/手机号/身份证号"></el-select>
      </el-form-item>
      <el-form-item>
        <el-select
          placeholder="发放通道"
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { prop: '', label: '上次接单' },
        { prop: '', label: '累计报名' },
        { prop: 'IntOrderPsn', label: '累计接单' },
        { prop: 'StrTaskpost', label: '任务描述' },
        { prop: '', label: '接单人范围' },
        { prop: '', label: '最大接单次数' },
        { prop: '', label: '任务海报' },
        { prop: '', label: '分享链接标题' },
        { prop: 'IntCalculate', label: '个人累计结算金额' },
        { prop: 'DecPay', label: '个人累计支付金额' },
      ],
      tableData: [],
    }
  },
